...
média 0.37 e
mediana 0.40.
Este número de clusters pode ser identificado cortando o dendrograma do agrupamento hierárquico na altura h = 2.2 (Figura 3).
...
Estipulando o número de clusters em k = 2, as silhuetas das observações variam entre
-0.38 e
0.67 com
média 0.34 e
mediana 0.38.
...
Table: **Tabela 3** Características dos clusters de deputados federais eleitos em 2018.
