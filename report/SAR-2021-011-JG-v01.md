...
1. **Remover os *outliers***.
  Isto implica em redefinir a população estudada (por exemplo, deputados federais com número de votos ou receita próximos do típico) e, portanto, ajustar o escopo do objetivo do estudo.
