...
Usando k = 3 clusters o WSS total foi 483.46 que explica 44.9% da variância.

Usando k = 2 clusters o WSS total foi 504.46 que explica 42.5% da variância.

## Determinação de clusters para k-means: cluster hierárquico

<div class="figure">
<img src="../figures/silhouette.png" alt="**Figura 3** Silhouette plot do cluster hierárquico." width="944" />
<p class="caption">**Figura 3** Silhouette plot do cluster hierárquico.</p>
</div>

<div class="figure">
<img src="../figures/dendrograma.png" alt="**Figura 4** Dendrograma do cluster hierárquico, corte na altura h = 2.2." width="944" />
<p class="caption">**Figura 4** Dendrograma do cluster hierárquico, corte na altura h = 2.2.</p>
</div>
...
<div class="figure">
<img src="../figures/dendrograma_full.png" alt="**Figura 7** Dendrograma do cluster hierárquico com o dataset completo, cortes nas alturas h = 3.85 (azul) e h = 2.75 (vermelho)." width="944" />
<p class="caption">**Figura 7** Dendrograma do cluster hierárquico com o dataset completo, cortes nas alturas h = 3.85 (azul) e h = 2.75 (vermelho).</p>
</div>
