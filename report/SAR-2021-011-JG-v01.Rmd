...
```{r fig4, fig.cap="**Figura 4** Dendrograma do cluster hierárquico, corte na altura h = 2.6."}
# ![Age](../figures/silhouette.png)
knitr::include_graphics("../figures/arvore.png", error = FALSE)
```
...
# ![Age](../figures/silhouette.png)
knitr::include_graphics("../figures/arvore_full.png", error = FALSE)
```
